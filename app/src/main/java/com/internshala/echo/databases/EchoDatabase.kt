        ...
        try {
            ...
            if (cSor.moveToFirst()) {
                do {
                    ...
                    var _artist = cSor.getInt(cSor.getColumnIndexOrThrow(Staticated.COLUMN_SONG_ARTIST))
                    var _title = cSor.getInt(cSor.getColumnIndexOrThrow(Staticated.COLUMN_SONG_TITLE))
                    var _songPath = cSor.getInt(cSor.getColumnIndexOrThrow(Staticated.COLUMN_SONG_PATH))
