        ...
        fun onSongComplete() {
            if (Statified.currentSongHelper?.isShuffle as Boolean) {
                ...
                if (Statified.currentSongHelper?.isLoop as Boolean) {
                    ...
                    Statified.currentSongHelper?.songPath = nextSong?.songData.toString()
                    Statified.currentSongHelper?.songTitle = nextSong?.songTitle.toString()
                    Statified.currentSongHelper?.songArtist = nextSong?.artist.toString()
                    Statified.currentSongHelper?.songId = (nextSong?.songID as Long).toString()
...
//                )
        ...
        fun playNext(check: String) {
            ...
            Statified.currentSongHelper?.songPath = nextSongs?.songData.toString()
            Statified.currentSongHelper?.songTitle = nextSongs?.songTitle.toString()
            Statified.currentSongHelper?.songArtist = nextSongs?.artist.toString()
            Statified.currentSongHelper?.songId = (nextSongs?.songID as Long).toString()
...
//                    Uri.parse(Statified.currentSongHelper?.songPath)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            Statified.currentSongHelper?.songId = songId.toString()
            Statified.currentSongHelper?.currentPosition = Statified.currentPosition
